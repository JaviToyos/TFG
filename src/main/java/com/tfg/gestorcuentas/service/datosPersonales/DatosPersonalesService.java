...
public class DatosPersonalesService implements IDatosPersonalesService {
    ...
    public String updateDatosPersonales(DatosPersonales datosPersonales) throws NoSuchElementException, IllegalArgumentException {
        ...
        Optional<PersonaEntity> entityPersona = iPersonaJPARepository.findByDni(datosPersonales.getPersona().getDni());
        PersonaEntity persona = entityPersona.orElseThrow(() -> new NoSuchElementException(MessageErrors.PERSON_NOT_FOUND.getErrorCode()));
