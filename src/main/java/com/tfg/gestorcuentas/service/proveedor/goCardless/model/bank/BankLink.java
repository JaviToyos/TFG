...
public class BankLink implements Serializable {
    ...
    public BankLink(String id, String redirect, StringStatus stringStatus, String agreements, List<String> accounts, Integer reference, String user_language, String link) {
        this.id = id;
